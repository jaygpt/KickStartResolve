...
var NewRequest = function (_Component) {
                ...
                return _regenerator2.default.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 10:
                                _routes.Router.pushRoute('/campaign/' + _this.props.address + '/request');
                                _context.next = 16;
                                break;
    ...
    (0, _createClass3.default)(NewRequest, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_layout2.default, null, _react2.default.createElement(_routes.Link, { route: '/campaign/' + this.props.address + '/requests' }, _react2.default.createElement('a', null, 'Back')), _react2.default.createElement('h1', null, 'Create Request'), _react2.default.createElement(_semanticUiReact.Form, { onSubmit: this.onSubmit, error: !!this.state.errorMessage }, _react2.default.createElement(_semanticUiReact.Form.Field, null, _react2.default.createElement('label', null, 'Descripton'), _react2.default.createElement(_semanticUiReact.Input, {
            ...
            })), _react2.default.createElement(_semanticUiReact.Message, { error: true, header: 'Oops!', content: this.state.errorMessage }), _react2.default.createElement(_semanticUiReact.Button, { primary: true, loading: this.state.loading }, 'Create Request ')));
        }
    }], [{
        key: 'getInitialProps',
        value: function () {
